...
* `broom`: Converting regression outputs to tidy tibbles
...
* `global-figure.R`: Generate histograms of the global rating distributions broken down by gender, for various data filters.
